...
extension Quit {
    static var exampleArray: [Quit] {
        ...
        addictions.append(Quit(id: UUID.init(),name: "Alkohol", description: "", dateStart: yesterday - 1, ammount: 32.12))
        addictions.append(Quit(id: UUID.init(),name: "Zielsko", description: "", dateStart: yesterday - 3, ammount: 40.00))
        addictions.append(Quit(id: UUID.init(),name: "Kofeina", description: "", dateStart: yesterday - 4, ammount: 6.63))
        addictions.append(Quit(id: UUID.init(),name: "Kokaina", description: "", dateStart: yesterday + 1, ammount: 160))
        ...
        addictions.append(Quit(id: UUID.init(),name: "Makaron", description: "", dateStart: yesterday + 123123, ammount: 5.53))
